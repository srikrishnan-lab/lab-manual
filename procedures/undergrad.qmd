...
Specific language on this page comes from the [Doss-Gollin Lab](https://dossgollin-lab.github.io/joinus/undergrad.html).
:::
...
1. Decide which path fits you: [Research for Credit](#research-for-credit), [Honors Thesis](#honors-thesis-supervision), or [Research for Pay](#research-for-pay).
2. Check what's expected of undergrad researchers in [What We're Looking For](#what-were-looking-for) below.
3. Send Vivek the application email described in that path's "How To Apply" steps.
:::
...
Specifically advertised positions for pay will be publicized on the research group's ["Join Us"](https://srikrishnan-lab.github.io/join/) page. However, you may always contact Vivek if you have a specific idea.

## What We're Looking For

If you are doing research in the lab group, you will be [expected](../expectations/roles.qmd#undergraduate-students) to participate in lab meetings and be available on Slack. Beyond that, we're mainly looking for genuine interest in the topic and a realistic sense of the time you can commit (see [Research for Credit](#research-for-credit) below for the standard 3-hours-per-credit-hour expectation) &mdash; you don't need prior research experience to reach out.
...
Send Vivek an [email](mailto:viveks@cornell.edu) from your Cornell University account:
...
If your email and proposal read as though a language model wrote them, they will not get a substantive reply.

They exist to show you have thought about what you want to research and why. A model cannot do that for you --- it does not know what you want, and what comes back is fluent, warm, and specific about nothing. The [project proposal](#proposal) is not graded on polish, and it is explicitly not a binding contract; it is evidence that there is a specific person with specific interests behind the application. A generated one is evidence of nothing.

If you cannot write a page or two in your own voice about why this research interests you, the fit probably is not there.
...
### How To Apply (Honors Thesis) {#apply-honors}
...
## How to Write a Project Proposal {#proposal}

There is a [template you can start from](../templates/project-proposal.md) if a blank page is the obstacle. Using it is optional, and a proposal that ignores its headings entirely is fine so long as it covers the same ground.

The project proposal is the first draft of your semester research plan. This document will lay out research questions and goals, milestones and timelines, the tools you will need, and the mentoring and guidance you anticipate requiring. The proposal is not intended to be a binding contract, and will likely change upon further discussion. The main goal of the project proposal is to convince Vivek of the following:
...
If you ask Vivek a question, in person or in email, that seems extremely relevant for others to know, he may ask your permission to post that question (anonymously) and answer in this section to help future prospective students.
