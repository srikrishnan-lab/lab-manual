...
3. If there's mutual interest, expect a video chat, a short guided paper evaluation, and then your formal application (see [Application Process](#application-process)).
...
Polishing your own prose afterward is fine. This is also a narrower rule than the one governing the [guided paper evaluation](#guided-paper-evaluation) below, where you *may* use a language model so long as you disclose and cite it. That is a supervised exercise with stated rules; this is the part where we are trying to find out whether there is a specific person with specific interests on the other end.
:::
