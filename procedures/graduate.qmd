...
::: {#quick-start .callout-tip}
## Quick Start

1. [Email Vivek expressing interest](#interest) &mdash; well ahead of the admissions deadline.
2. Apply through the [Graduate School's Admissions site](https://gradschool.cornell.edu/admissions/apply/) to a field in which Vivek is a member (see [How to Apply](#how-to-apply) below).
3. If there's mutual interest, expect a video chat, a short guided paper evaluation and a conversation about it, and then your formal application (see [Application Process](#application-process)).

Also see the expectations for [Graduate Students](../expectations/roles.qmd#graduate-students) in the group.
:::
...
Vivek is a member of the graduate faculty in four fields. Each sets its own application deadline, and you apply to one of them rather than to the group:

| Field | Deadline | Source |
|---|---|---|
| [Biological & Environmental Engineering](https://cals.cornell.edu/education/degrees-programs/graduate-field-biological-environmental-engineering) | Not published on the field's own page | Check the [Graduate School field listing](https://gradschool.cornell.edu/admissions/degrees-fields/cugradfos/) |
| [Civil & Environmental Engineering](https://www.duffield.cornell.edu/cee/programs/graduate-programs/) | Not published on the field's own page | Check the [Graduate School field listing](https://gradschool.cornell.edu/admissions/degrees-fields/cugradfos/) |
| [Atmospheric Science](https://www.duffield.cornell.edu/eas/programs/graduate-programs/atmospheric-science-graduate-program/applying-admission) | **January 1** for fall, **September 15** for spring; GRE not required | [EAS admissions](https://www.duffield.cornell.edu/eas/programs/graduate-programs/atmospheric-science-graduate-program/applying-admission) |
| [Systems Engineering](https://www.duffield.cornell.edu/sys/ms-phd-faqs/) | **January 1** for the following September | [Systems Engineering FAQ](https://www.duffield.cornell.edu/sys/ms-phd-faqs/) |

::: {.callout-warning}
## Confirm the Deadline Yourself

Deadlines move, and this table was last checked in September 2026. Always confirm against the field's own page before you plan around a date here. Two of the four fields do not publish a deadline on their own site at all, so for those the [Graduate School's field listing](https://gradschool.cornell.edu/admissions/degrees-fields/cugradfos/) is the authoritative source.

The Graduate School application itself generally opens in early September and closes in mid-June; individual field deadlines fall inside that window and are much earlier.
:::
...
You can apply to the aforementioned fields without contacting faculty ahead of time, but as noted in [Quick Start](#quick-start), reaching out early increases the odds we can confirm a good mutual fit and that your application will be given priority.

### Professional Programs (M.Eng. and M.P.S.)

M.Eng. and M.P.S. students should also follow the [Quick Start](#quick-start) steps and ask if he has projects available. This does not need to be done too far ahead of the start of your first semester unless you specifically want to be supervised by Vivek, in which case you should inquire as early as possible.
...
A student will likely fit well in our group if they are broadly interested in climate risk management, want to learn how to do interdisciplinary, collaborative work, and [are committed to upholding a harassment-free environment](../expectations/harassment.qmd).

We want our students (and everyone else!) to strike a healthy work-life balance. If you aren't sure whether you know how to find this balance, or know that you tend to get overwhelmed with your work, don't worry! Finding this balance is part of the maturing and mentoring process, and Vivek will do his best to help you, but you have to want to find it. [There is no virtue in burying yourself so deeply in your work that your mental, physical, and emotional well-being suffer](../expectations/health.qmd). It helps if you have hobbies and interests outside of work. These will help keep you from burning out and increase your creativity and productivity!
...
1. ***Programming in some major language (C++, R, Python, etc)***: While we aren't sticklers for language (we want to use the right tool for a given job), we generally try to [avoid working with proprietary software](../expectations/open.qmd), such as MATLAB and GAMS. It helps when the group focuses on a couple of programming languages to facilitate collaboration. We tend to focus on R, Python, and Julia, though there are times when C or C++ is required. However, if you know some other languages, you should be able to pick these up with some effort and code examples, so don't worry too much if you haven't used these specific languages before.
...
## Send An Email Expressing Interest {#interest}
...
* **Expect a reply within about a week**: Vivek aims to respond to inquiries within a week. If it has been noticeably longer, a short follow-up is welcome rather than presumptuous --- messages do get buried, particularly around deadlines and the start of a semester.
...
This email exists to show you have read our work and thought about the fit. A model cannot do that for you --- it does not know what you want, and what comes back is fluent, warm, and specific about nothing.
...
This is stricter than what governs the [guided paper evaluation](#guided-paper-evaluation) later in the process, where you may use a language model as long as you say so. The difference is that the evaluation gets discussed with you afterward, so it does not much matter how the draft got written; this email is the only thing we have to go on, and it is the part where we are trying to find out whether there is a specific person with specific interests on the other end.
:::
...
Vivek will send you an email asking you to provide a written evaluation of a paper, which he will provide in that email. This paper will be selected based on your discussed interests.

::: {.callout-note}
## This Is a Conversation, Not a Test

The written response is the starting point, not the whole exercise. Vivek will follow up with a short discussion --- usually about fifteen minutes, often folded into the [video chat](#video-chats) --- about what you wrote and why.

That conversation is the part that matters. We are trying to learn how you read a paper, what you noticed, and what you did when you hit something you didn't understand. None of that comes through clearly on the page, and all of it comes through in five minutes of talking.
:::

Your evaluation should be no more than two pages (no more than 12 point font and no less than one inch page margins). Address several of the following prompts about the paper:
...
Then address at least one of these, which are about *your reading* rather than about the paper:

* What did you have to look up in order to get through this? A method, a term, a cited paper --- whatever it was.
* Which part was hardest for you, and what did you do about it?
* Was there anything you are still not sure you understood?

The second set is not a trap, and there is no penalty for a long answer. Research consists largely of reading things you do not yet understand and working out how to proceed anyway; being able to say clearly what you don't know is a skill we are actively looking for, and one that many strong applicants undersell. "I couldn't follow the Bayesian calibration in §3, so I read the Kennedy and O'Hagan paper it cites and got about halfway" is a better answer than a confident summary that papers over the same gap.
...
4. You *may* use large language models (*e.g.*, ChatGPT) while working on this. If you do, include a sentence or two saying what you used and what for. We would much rather know than not, and it is useful information about how you work rather than a mark against you --- how people actually use these tools is something the group is still figuring out too.[^1]

    Bear in mind what the exercise is for. Vivek will discuss your response with you, and the questions will be about this particular paper and your particular reading of it. A response you did not think through yourself is difficult to talk about, and that is the main reason outsourcing this tends to backfire --- not because it breaks a rule, but because the conversation is the point and you will have skipped the preparation for it.

[^1]: This is a narrower ask than earlier versions of this page made. We used to require citing the exact prompts and documenting how you fact-checked the output. That was more bookkeeping than it was worth, and it mostly penalized applicants who were candid about using a tool that others were using silently.
