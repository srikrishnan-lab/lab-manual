...
1. Start with an [outline](#outline) and [paper contract](#paper-contract). This will help lay out the goals of the research and make sure all projected authors know their expected contributions and how key terms are being used (as vocabularies can vary across disciplines or even sub-disciplines -- the [Glossary](../kb/glossary.qmd) records how this group uses the ambiguous ones).
...
10. [Include as coauthors](authorship.qmd) only those persons who have made significant scientific contributions to the work and determine order of authorship in a manner appropriate to the contribution. All coauthors share responsibility for the quality and integrity of the submitted and published manuscript.
