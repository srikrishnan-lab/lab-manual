...
- [ ] Draft the AI-use disclosure statement if one is needed, checked against the target journal's *current* policy (see [AI Tools in Research](ai-tools.qmd)).
- [ ] Check that:
...
- [ ] Mint releases of relevant data and codes and get relevant DOIs (see [GitHub and Zenodo](github-zenodo.qmd) -- the model gets released *before* the meta-repository, and papers cite the **version** DOI, not the concept DOI).
