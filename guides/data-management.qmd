...
Archive to something with a DOI, which for us usually means minting a Zenodo release from the GitHub repository. GitHub itself is not an archive: repositories can be deleted, renamed, or made private, and a bare GitHub URL in a data availability statement will eventually rot. [GitHub and Zenodo](github-zenodo.qmd) covers the mechanics and the order the steps have to happen in.
